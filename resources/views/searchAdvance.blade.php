    ...
    <table class="w-full border border-neutral-300 rounded overflow-hidden shadow-lg" align="center">
        ...
        <tr class="runner-row style1 runner-b-srchfields">
            ...
            <td class="runner-cc alt"><span id="edit1_Agente_Richiedente_0" class="runner-nowrap""><select
                        ...
                        <option value="Angelo Anticoli">Angelo Anticoli</option>
                        <option value="annalisa pica">annalisa pica</option>
                        <option value="antonio">antonio</option>
                        <option value="Anwar">Anwar</option>
                        <option value="Carmen Mazzoccoli">Carmen Mazzoccoli</option>
                        <option value="claudio">claudio</option>
                        <option value="daniela lanza">daniela lanza</option>
                        <option value="daniele">daniele</option>
                        <option value="danila">danila</option>
                        <option value="Davide">Davide</option>
                        <option value="Donatella Giallara">Donatella Giallara</option>
                        <option value="Emanuele">Emanuele</option>
                        <option value="Eva Mazzetti">Eva Mazzetti</option>
                        <option value="Fabrizia">Fabrizia</option>
                        <option value="federica">federica</option>
                        <option value="francescofrano">francescofrano</option>
                        <option value="garibaldi">garibaldi</option>
                        <option value="Gianluca">Gianluca</option>
                        <option value="gianpaolo">gianpaolo</option>
                        <option value="giordano">giordano</option>
                        <option value="helpdeskRDS">helpdeskRDS</option>
                        <option value="Jacopo">Jacopo</option>
                        <option value="Jacopo Palizzi">Jacopo Palizzi</option>
                        <option value="KATIA RAITERI">KATIA RAITERI</option>
                        <option value="l.luciano">l.luciano</option>
                        <option value="Luca Maria Brogli">Luca Maria Brogli</option>
                        <option value="luigiprimavesi">luigiprimavesi</option>
                        <option value="Marco">Marco</option>
                        <option value="Maria Luisa">Maria Luisa</option>
                        <option value="Massimiliano">Massimiliano</option>
                        <option value="mauro">mauro</option>
                        <option value="Meneghin">Meneghin</option>
                        <option value="mirabilia">mirabilia</option>
                        <option value="Nicole">Nicole</option>
                        <option value="Prova">Prova</option>
                        <option value="r.depra">r.depra</option>
                        <option value="raiteri catia">raiteri catia</option>
                        <option value="RCori">RCori</option>
                        <option value="Riccardo Carnassale">Riccardo Carnassale</option>
                        <option value="Roberto">Roberto</option>
                        <option value="Rocco">Rocco</option>
                        <option value="scozzi">scozzi</option>
                        <option value="simone">simone</option>
                        <option value="stefano">stefano</option>
                        <option value="tatiana">tatiana</option>
                        <option value="tatiana coccia">tatiana coccia</option>
                        <option value="user">user</option>
                        <option value="valeria">valeria</option>
                        <option value="valerialugli23">valerialugli23</option>
                        <option value="zpower">zpower</option>
                    </select></span>&nbsp;</td>
            <td class="runner-cc alt">&nbsp;</td>
            <td class="runner-cr alt"></td>
        </tr>
        ...
        <tr class="runner-row style1 runner-b-srchfields">
            ...
            <td class="runner-cc alt"><span id="edit1_Agente_Assegnato_0" class="runner-nowrap""><select size = "1"
                        ...
                        <option value="20">alessia</option>
                        <option value="61">Angelo Anticoli</option>
                        <option value="26">annalisa pica</option>
                        <option value="33">antonio</option>
                        <option value="111">Anwar</option>
                        <option value="53">Carmen Mazzoccoli</option>
                        <option value="19">claudio</option>
                        <option value="23">daniela lanza</option>
                        <option value="1">daniele</option>
                        <option value="36">danila</option>
                        <option value="84">Davide</option>
                        <option value="44">Donatella Giallara</option>
                        <option value="37">Emanuele</option>
                        <option value="25">Eva Mazzetti</option>
                        <option value="105">Fabrizia</option>
                        <option value="56">federica</option>
                        <option value="27">francescofrano</option>
                        <option value="65">garibaldi</option>
                        <option value="106">Gianluca</option>
                        <option value="59">gianpaolo</option>
                        <option value="60">giordano</option>
                        <option value="91">helpdeskRDS</option>
                        <option value="24">Jacopo</option>
                        <option value="45">Jacopo Palizzi</option>
                        <option value="38">KATIA RAITERI</option>
                        <option value="43">l.luciano</option>
                        <option value="51">Luca Maria Brogli</option>
                        <option value="46">luigiprimavesi</option>
                        <option value="50">Marco</option>
                        <option value="89">Maria Luisa</option>
                        <option value="110">Massimiliano</option>
                        <option value="2">mauro</option>
                        <option value="82">Meneghin</option>
                        <option value="81">mirabilia</option>
                        <option value="64">Nicole</option>
                        <option value="112">Prova</option>
                        <option value="35">r.depra</option>
                        <option value="57">raiteri catia</option>
                        <option value="40">RCori</option>
                        <option value="92">Riccardo Carnassale</option>
                        <option value="109">Roberto</option>
                        <option value="83">Rocco</option>
                        <option value="62">scozzi</option>
                        <option value="49">simone</option>
                        <option value="48">stefano</option>
                        <option value="85">tatiana</option>
                        <option value="86">tatiana coccia</option>
                        <option value="42">user</option>
                        <option value="47">valeria</option>
                        <option value="63">valerialugli23</option>
                        <option value="34">zpower</option>
                    </select></span>&nbsp;</td>
            <td class="runner-cc alt">&nbsp;</td>
            <td class="runner-cr alt"></td>
        </tr>
        ...
        <tr class="runner-row style1 runner-b-srchfields">
            ...
            <td class="runner-cc alt"><span id="searchType_1_Sito"><select id="srchOpt_1_Sito" NAME="srchOpt_1_Sito"
                        SIZE=1>
                        <option value="Contains">Contiene</option>
                        <option value="Equals">Uguale</option>
                        <option value="Starts with">Incomincia per</option>
