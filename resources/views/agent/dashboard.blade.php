...
<script>
    ...
    if(curr_location.includes('?')){
        curr_location=curr_location+"&sort=";
}else{
    curr_location=curr_location+"?sort=";

}
</script>
<select onchange="location.assign(curr_location + this.options[this.selectedIndex].value)" class="sortingby">
            <option value="">Ordina per</option>
            <option value="data_modifica_asc">Data Modifica crescente</option>
            <option value="data_modifica_desc">Data Modifica decrescente</option>
            <option value="creazione_asc">Creazione crescente</option>
            <option value="creazione_desc">Creazione decrescente{{Session::get('sort')}}</option>
        </select>
                                ...
                                <th scope="col" class="px-6 py-4">
                                    <div class="mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem]">
                                        <input
                                            ...
                                            type="checkbox" onclick="addAllCheckbox()" value="" id="checkboxDefault" />
                                    </div>
                                </th>
                        ...
                        <tbody>
                            @foreach ($information as $info)
                                <tr class="border-b bg-neutral-100 dark:border-neutral-500 dark:bg-neutral-700">
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4">
                                        <div class="mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem]">
                                            <input
                                                ...
                                                onclick="Checkbox({{ $info->ID }})" type="checkbox" value="{{ $info->ID }}" id="checkboxDefault" />
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4">{{ $info->Part_Ev == 'SI' ? 'Si' : 'No' }}</td>
