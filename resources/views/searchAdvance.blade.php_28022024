...
@section('content')
    ...
    <table class="w-full border border-neutral-300 rounded overflow-hidden shadow-lg" align="center">
        ...
        <tr class="runner-row style1 runner-b-srchfields">
            ...
            <td class="runner-cc alt"><span id="searchType_1_ID"><select id="srchOpt_1_ID" NAME="id_selection" SIZE=1>
                        <option value="Contains">Contiene</option>
                        <option value="Equals">Uguale</option>
                        <option value="Starts with">Incomincia per</option>
                        <option value="More than">Più di</option>
            ...
            <td class="runner-cc alt"><span id="edit1_ID_0" class="runner-nowrap""><input id=" value_ID_1"
                        style="" type="text" autocomplete="off" name="ID" value=""></span>&nbsp;
            </td>
        ...
        <tr class="runner-row style1 runner-b-srchfields">
            ...
            <td class="runner-cc alt"><span id="edit1_Agente_Richiedente_0" class="runner-nowrap""><select size=" 1"
                        id="value_Agente_Richiedente_1" name="agente_richiedente_selection_user">
        ...
        <tr class="runner-row style1 runner-b-srchfields">
            ...
            <td class="runner-cc alt"><span id="searchType_1_Tipologia_Cliente"><select id="srchOpt_1_Tipologia_Cliente"
                        NAME="tipologia_cliente_selection_1" SIZE=1>
                        <option value="Equals">Uguale</option>
                    </select></span></td>
        ...
        <tr class="runner-row style1 runner-b-srchfields">
            ...
            <td class="runner-cc alt"><span id="searchType_1_Citta"><select id="srchOpt_1_Citta" NAME="city_selection"
                        SIZE=1>
                        <option value="Contains">Contiene</option>
                        <option value="Equals">Uguale</option>
                        <option value="Starts with">Incomincia per</option>
        ...
        <tr class="runner-row style1 runner-b-srchfields">
            ...
            <td class="runner-cc alt"><span id="edit1_Indirizzo_0" class="runner-nowrap""><input id=" value_Indirizzo_1"
                        style="" type="text" autocomplete="off" name="Indirizzo"
                        value=""></span>&nbsp;</td>
        ...
        <tr class="runner-row style1 runner-b-srchfields">
            ...
            <td class="runner-cc alt"><span id="edit1_Referente_0" class="runner-nowrap""><input id=" value_Referente_1"
                        style="" type="text" autocomplete="off" name="Referente"
                        value=""></span>&nbsp;</td>
        ...
        <tr class="runner-row style1 runner-b-srchfields">
            ...
            <td class="runner-cc alt"><span id="edit1_Compleanno_0" class="runner-nowrap"">
                <input id=" value_Compleanno_1" type="Text" name="Compleanno" size="20" value=""> </td>
        ...
        <tr class="runner-row style1 runner-b-srchfields">
            ...
            <td class="runner-cc alt"><span id="edit1_Telefono_0" class="runner-nowrap""><input id=" value_Telefono_1"
                        style="" type="text" autocomplete="off" name="Telefono"
                        value=""></span>&nbsp;</td>
        ...
        <tr class="runner-row style1 runner-b-srchfields">
            ...
            <td class="runner-cc alt"><span id="searchType_1_Part__Eventi">
                <select id="srchOpt_1_Part__Eventi"
                        NAME="part_eventi_selection_1" SIZE=1>
                        <option value="Equals">Uguale</option>
                    </select></span></td>
        ...
        <tr class="runner-row style1 runner-b-srchfields">
            ...
            <td class="runner-cc alt"><span id="edit1_Note_Eventi_0" class="runner-nowrap""><input
                        ...
                        name="Note_ev" rows=20 cols=500 value=""></span>&nbsp;</td>
