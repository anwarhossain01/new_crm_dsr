                                ...
                                <div class="flex flex-wrap justify-center">
                                    @if (!$is_user)
                                        ...
                                        <div class="mb-[0.125rem] mr-4 inline-block min-h-[1.5rem] pl-[1.5rem]">
                                            ...
                                            <label
                                                class="radio-butt mt-px inline-block pl-[0.15rem] hover:cursor-pointer"
                    ...
                    <div class="flex flex-wrap flex-wrap justify-center">
                        <div class="mr-8 flex-1">
                            ...
                            <div class="relative mb-3">
                                ...
                                <p class="hidden text-xs text-red-500" id="azendaError">This Item Already Exists</p>
                            ...
                            <div class="mb-3 flex items-center">
                                <div class="relative flex-1">
                                    ...
                                    <p class="hidden text-xs text-red-500" id="brandError">This Item Already Exists
                                    </p>
                                    <p class="hidden text-xs text-green-500" id="brandSuccess">Item is ok</p>
                                </div>

                                <button onclick="checkForMatchingBrand()" class="ml-3 h-1/2 rounded bg-blue-500 p-2"
                                    type="button">
...
<script>
    ...
    function checkForMatchingBrand() {

        let input = document.getElementById('brandInput');
        // create a new XMLHttpRequest
        var xhr = new XMLHttpRequest();
        let errorTxt = document.getElementById('brandError');
        let successTxt = document.getElementById('brandSuccess');
        errorTxt.classList.add('hidden');
