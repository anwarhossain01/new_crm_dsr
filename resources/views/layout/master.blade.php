...
<body class="bg-slate-200">
    <div class="p-4">
        ...
        <nav class="flex-no-wrap relative flex w-full items-center justify-between bg-[#FBFBFB] py-2 shadow-md shadow-black/5 dark:bg-neutral-600 dark:shadow-black/10 print:hidden lg:flex-wrap lg:justify-start lg:py-4">
            <div class="flex w-full flex-wrap items-center justify-between px-3">
                ...
                <button class="block border-0 bg-transparent px-2 text-neutral-500 hover:no-underline hover:shadow-none focus:no-underline focus:shadow-none focus:outline-none focus:ring-0 dark:text-neutral-200 lg:hidden"
                    ...
                    <span class="[&>svg]:w-7">
		                ...
		                <a href="/"><img src="{{ asset('public/logo.png') }}" class="logocrmdsrmobile" alt="CRM DSR" title="CRM DSR" loading="lazy" /></a>
		                </div>
                ...
                <div class="!visible hidden flex-grow basis-[100%] items-center lg:!flex lg:basis-auto"
                    ...
                    <!-- Logo -->
                    <div class="logo-mobile">
                    <a href="/"><img src="{{ asset('public/logo.png') }}" class="logocrmdsr" alt="CRM DSR" title="CRM DSR" loading="lazy" /></a>
                    </div>
                    <a class="mb-4 ml-2 mr-5 mt-3 flex items-center text-neutral-900 hover:text-neutral-900 focus:text-neutral-900 dark:text-neutral-200 dark:hover:text-neutral-400 dark:focus:text-neutral-400 lg:mb-0 lg:mt-0"
                        href="#">
                        <img src="{{ asset('public/logo.jpg') }}" style="height: 31px" alt="TE Logo" loading="lazy" />
                    </a>
                    ...
                    <ul class="list-style-none mr-auto flex flex-col pl-0 lg:flex-row" data-te-navbar-nav-ref>
                        ...
                        @php
                        $userGroup = Auth::user()->Gruppo;
                        $route = '';
                    
                        if ($userGroup === 'Admin' || $userGroup === 'Power') {
                            if (Str::startsWith(Route::currentRouteName(), 'collab')) {
                                $route = route('print.collab.all');
                            } else {
                                $route = route('print.all');
                            }
                        } else {
                            $route = route('print.user.all');
                        }
                    @endphp
                ...
                <!-- Right elements -->
                <div class="relative flex items-center logintool">
                    ...
                    <div class="relative" data-te-dropdown-ref data-te-dropdown-alignment="end">
                        ...
                        <a class="hidden-arrow flex items-center whitespace-nowrap transition duration-150 ease-in-out motion-reduce:transition-none"
                            ...
                            <!--<svg class="h-6 w-6 text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <img src="/img/icon_edit_user.png" class="icon-user" alt="Gestisci Utente" title="Gestisci Utente">
                        </a>
